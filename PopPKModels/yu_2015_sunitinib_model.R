...
$TABLE	// Calculate parent and metabolite concentrations
				double IPREP = CENTP/VCP*1000;	// Convert to ng/mL
				double IPREM = CENTM/VCM*1000;	// Convert to ng/mL

$CAPTURE WT CLP VCP QH CLM VCM QI VPM IPREP IPREM
'
# Compile the model code
	mod <- mcode("popSUN",code)
